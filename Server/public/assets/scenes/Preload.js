export class Preload extends Phaser.Scene {
    ...
    createLoadingView() {
        ...
        // Make a handle to update progress procent when loading a file
        this.load.on('progress', function (value) {
            percentText.setText(parseInt(value * 100) + '%');
        });
        
        // Make a handle to update filename when a new file is being loaded
    ...
    create() {
        // Create animations for adventure sprite
